...
/**
 * HOOK: Denetim İzi (Audit Log) sayfası için veri kaynağı.
 * Ticket geçmişi (TicketContext) + /api/audit uç noktasından gelen kayıtları tek,
 * tarihe göre sıralanmış bir log listesinde birleştirir. Önceden denetim-izi/page.tsx
 * içine gömülüydü, tekrar kullanılabilir olsun diye ayrı hook'a çıkarıldı.
 */
