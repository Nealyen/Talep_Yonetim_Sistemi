/**
 * DOSYA: Kategori kataloğu ve diğer sabit seçenek listeleri.
 * DİKKAT: CATEGORY_DATA sadece SEED/başlangıç + referans katalog verisidir. Asıl
 * ÇALIŞAN veri CategoryContext.tsx üzerinden localStorage'da tutulur — bu dosyayı elle
 * değiştirmek, zaten kurulmuş bir projede hiçbir şeyi otomatik güncellemez. Burası
 * şu an sadece Kategori Yönetimi'ndeki Alt Başlık dropdown'ının "resmî katalog
 * referansı" olarak kullanılıyor (bkz. useKategoriYonetimi.ts → getAltBaslikOptions).
 */
