...
/**
 * BİLEŞEN: "Mesai Onayları" butonu — rozet sayısını (bekleyen onay adedi), modal
 * açma/kapamayı ve onay/red işlemini kendi içinde yönetir. Birden fazla sayfada
 * (tum-talepler, taleplerim, is-havuzu vb.) tekrar kullanılabilsin diye ortak
 * bileşen haline getirilmiştir.
 */
