...
/**
 * BİLEŞEN: Yeni Talep formu — "Talep Eden Bilgileri" bölümü. Giriş yapan kullanıcının
 * bilgilerini salt-okunur olarak gösterir (currentUser'dan otomatik doldurulur).
 */
