...
/**
 * BİLEŞEN: Yeni Talep formu — Üst Başlık / Alt Başlık seçim bölümü.
 * Seçenekler artık Kategori Yönetimi'ndeki kataloğa bağlı (hooks/useNewTicketForm.ts
 * üzerinden CategoryContext'ten geliyor), statik değil.
 */
