...
/**
 * BİLEŞEN: Yeni Talep formu — PC adı, IP, dahili, oda no, açıklama, barkod/dosya
 * yükleme gibi detay alanlarını içeren bölüm. FileUpload, sahte /api/upload uç
 * noktasına gönderim yapar (gerçek depolama backend'i yok, bkz. app/api/upload.ts).
 */
