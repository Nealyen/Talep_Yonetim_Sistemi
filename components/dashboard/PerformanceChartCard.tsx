...
/**
 * BİLEŞEN: Tek bir doughnut grafik + özel legend gösteren performans kartı.
 * Dashboard'da "Son 1 Ay / Son 3 Ay / Tüm Zamanlar" için 3 kez kullanılır — veri
 * hooks/useDashboardCharts.ts'ten (ChartBundle) gelir.
 */
