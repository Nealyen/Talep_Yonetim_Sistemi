/**
 * SAYFA: 404 - Bulunamadı — Rota: "/pages/notfound"
 * KİMLER GÖREBİLİR: Herkes.
 * NE İŞE YARAR: PrimeReact "Sakai" şablonundan gelen HAZIR bir 404 sayfası. Next.js'in
 * kendi otomatik 404 mekanizmasından (app/not-found.tsx) FARKLI bir dosyadır ve rota
 * olarak sadece "/pages/notfound" adresine gidildiğinde açılır — projede buraya
 * yönlendiren bir link YOK, yani fiilen kullanılmayan bir şablon kalıntısıdır. Linkler
 * ("Frequently Asked Questions", "Solution Center", "Permission Manager") gerçek SSS/
 * yardım sayfalarına değil, hepsi "/" anasayfaya gider — bağlanmamış demo içerik.
 */
