...
/**
 * SAYFA: Erişim Reddedildi (Access Denied) — Rota: "/auth/access"
 * KİMLER GÖREBİLİR: Kimse (route'a giden aktif bir link/redirect yok — bkz. NE İŞE YARAR).
 * NE İŞE YARAR: PrimeReact "Sakai" şablonundan gelen HAZIR bir hata sayfası. Şu an
 * projenin geri kalanında HİÇBİR YERDEN bu rotaya link/redirect verilmiyor — kodda
 * bağlı/kullanılan bir sayfa DEĞİL. Gerçekte yetkisiz erişimde ne oluyor: bkz.
 * layout/RoleRouteGuard.tsx → yetkisiz kullanıcı bu sayfaya değil, doğrudan "/" (ana
 * sayfa)'ya yönlendiriliyor (router.replace('/')). Bu dosya ileride yetkisiz erişim
 * senaryosu için kullanılmaya hazır bekleyen bir kalıptır (template).
 */
