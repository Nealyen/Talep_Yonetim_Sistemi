...
/**
 * SAYFA: Tanıtım (Landing) Sayfası — Rota: "/landing"
 * KİMLER GÖREBİLİR: Herkes (herhangi bir yetki kontrolü yok).
 * NE İŞE YARAR: PrimeReact "Sakai" şablonundan gelen HAZIR bir pazarlama/tanıtım sayfası
 * (Lorem ipsum içerikli, "SAKAI" markalı, Login/Register butonları hiçbir yere
 * bağlanmıyor). Bu bir DEMO/ŞABLON kalıntısıdır — kurumsal talep portalının GERÇEK
 * kullanıcı akışının bir parçası DEĞİLDİR ve projenin hiçbir yerinden buraya link
 * verilmiyor. Silinmesi ya da gerçek bir kurumsal tanıtım sayfasıyla değiştirilmesi
 * güvenle düşünülebilir.
 */
