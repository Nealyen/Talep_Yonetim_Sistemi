/**
 * BİLEŞEN: "Yeni Rol Tanımla" — Kullanıcı & Rol Yönetimi sayfasının alt kısmı.
 * DİKKAT: Bu SADECE görsel bir arayüz taslağıdır, gerçek bir yetkilendirme sistemine
 * BAĞLI DEĞİLDİR. Girilen veriler component state'inde tutulur, sayfa yenilenince
 * kaybolur. Gerçek RBAC ileride ayrı bir iş olarak ele alınmalı.
 */
                        ...
                        <div key={role.id} className="flex align-items-center justify-content-between p-2 border-round surface-100">
                            <div>
                                ...
                                {role.permissions.map((p) => (
                                    <Tag key={p} value={p} severity="info" className="mr-1" />
                                ))}
