/**
 * BİLEŞEN: Tüm Talepler tablosu — sistemdeki tüm taleplerin genel izleme tablosu.
 * Admin yetkisiyle, sahibi olunmayan talepler de doğrudan düzenlenebilir (onEdit).
 */
...
export const TumTaleplerTablo = ({ tickets, isAdmin, onRowSelect, onEdit }: TumTaleplerTabloProps) => {
    ...
    return (
        ...
        >
            ...
            <Column field="team" header="İlgili Ekip" style={{ width: '150px' }} body={(rowData: Ticket) => rowData.team || <span className="text-500">Atanmadı</span>} />
