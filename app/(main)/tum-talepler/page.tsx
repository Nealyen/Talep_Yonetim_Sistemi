...
/**
 * SAYFA: Tüm Talepler (Genel İzleme Paneli) — Rota: "/tum-talepler"
 * KİMLER GÖREBİLİR: KOORDINATOR, ADMIN.
 * NE İŞE YARAR: Sistemdeki tüm (açık + kapalı) taleplerin, tüm birimler genelinde genel
 * izleme panosu. Admin yetkisiyle, sahibi olunmayan talepler de doğrudan düzenlenebilir
 * (TicketEditModal üzerinden).
 */
