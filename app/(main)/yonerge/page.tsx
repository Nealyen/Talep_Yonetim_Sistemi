...
/**
 * SAYFA: Yönerge — Rota: "/yonerge"
 * KİMLER GÖREBİLİR: Tüm roller.
 * NE İŞE YARAR: Kurumsal Arıza ve Talep Yönetim Yönergesi'nin resmi standartlar ve SLA
 * taahhütlerini içeren okunabilir, statik metin sayfası. Dinamik veri/context bağlantısı
 * yoktur.
 */
