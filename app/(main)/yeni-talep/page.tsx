...
/**
 * SAYFA: Yeni Talep Oluştur — Rota: "/yeni-talep"
 * KİMLER GÖREBİLİR: Tüm roller.
 * NE İŞE YARAR: Yeni destek talebi oluşturma formu. Üst Başlık / Alt Başlık seçimi artık
 * statik değil, Kategori Yönetimi sayfasında tanımlanan kataloğa (CategoryContext) bağlıdır;
 * Pasif işaretlenen alt başlıklar burada listelenmez. Form gönderildiğinde talep, seçilen
 * alt başlığın Kategori Yönetimi'nde atanmış olduğu ekibe otomatik olarak yönlendirilir.
 * İLGİLİ DOSYALAR: hooks/useNewTicketForm.ts, components/forms/newTicket/*
 */
