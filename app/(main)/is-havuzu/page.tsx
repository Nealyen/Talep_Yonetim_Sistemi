...
/**
 * SAYFA: Teknik İş Havuzu — Rota: "/is-havuzu"
 * KİMLER GÖREBİLİR: TEKNISYEN, KOORDINATOR, ADMIN.
 * NE İŞE YARAR: Henüz kimseye atanmamış, "YENİ" durumundaki (sahipsiz) taleplerin listesi;
 * buradan bir talep üstüne alınabilir (handleTakeOwnership).
 * DİKKAT — GÖRÜNÜRLÜK KURALI: Bir talep belirli bir ekibe eşlenmişse (Kategori Yönetimi'nde
 * tanımlı), havuzda SADECE o ekipteki teknisyenlere görünür ("her rol her işi görmesin"
 * kuralı, bkz. useIsHavuzu.ts → isVisibleToMe). Ekibi atanmamış (boş) talepler herkese
 * açık kalır. Admin/Koordinatör her zaman tüm havuzu görür.
 */
