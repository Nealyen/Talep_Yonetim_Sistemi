/**
 * BİLEŞEN: Ekip Listesi — Ekip Yönetimi sayfasının SOL tarafı.
 * NE İŞE YARAR: Ekip (grup) adlarının kendisinin eklenip silindiği basit liste.
 * Burada tanımlanan ekip adları, hem PersonelEkipEslestirme.tsx'teki eşleştirmede
 * hem de Kategori Yönetimi'ndeki "Ekip" dropdown'larında seçenek olarak kullanılır.
 */
