...
/**
 * SAYFA: Denetim İzi (Audit Log) — Rota: "/denetim-izi"
 * KİMLER GÖREBİLİR: ADMIN.
 * NE İŞE YARAR: 5651 sayılı kanun ve kurumsal kalite yönetimi standartlarına uygun,
 * değiştirilemez işlem kayıtları — kim, ne zaman, hangi talepte, ne yaptı.
 * İLGİLİ DOSYA: hooks/useAuditLogs.ts
 */
