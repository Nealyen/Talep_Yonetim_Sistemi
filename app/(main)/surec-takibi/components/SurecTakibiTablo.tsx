/**
 * BİLEŞEN: Sistem Süreç Takibi tablosu — SLA/koordinatör müdahale masasının ana tablosu,
 * buradan işler doğrudan teknisyene manuel atanabilir (ManualAssignDialog üzerinden).
 */
...
export const SurecTakibiTablo = ({ tickets, onAssign, onUnassign }: SurecTakibiTabloProps) => {
    return (
        <DataTable value={tickets} paginator rows={10} responsiveLayout="scroll" emptyMessage="Talep bulunamadı.">
            ...
            <Column field="team" header="İlgili Ekip" style={{ width: '140px' }} body={(rowData: Ticket) => rowData.team || <span className="text-500">Atanmadı</span>} />
