/**
 * BİLEŞEN: Aktif Görevlerim ana tablosu — kullanıcının üzerine aldığı/atandığı açık
 * işlerin listesi ve satır bazlı aksiyon butonları (ActiveTaskActionButtons).
 */
...
export const AktifGorevlerTablo = ({ tickets, onRowClick, onPreview, onComplete, onRelease, onDelegate }: AktifGorevlerTabloProps) => {
    return (
        ...
        >
            ...
            <Column field="team" header="İlgili Ekip" style={{ width: '180px' }} body={(rowData: Ticket) => rowData.team || <span className="text-500">Atanmadı</span>} />
