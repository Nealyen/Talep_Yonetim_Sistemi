...
/**
 * SAYFA: Geçmiş Talepler (Arşiv) — Rota: "/gecmis-talepler"
 * KİMLER GÖREBİLİR: Tüm roller; Admin/Koordinatör "Tüm Talepler" / "Kendi Taleplerim"
 * arasında geçiş yapabilir (SelectButton), diğer roller sadece kendi geçmişini görür.
 * NE İŞE YARAR: Kapatılmış (KAPATILDI) taleplerin kalıcı arşivi ve filtrelemesi.
 * DİKKAT: Aynı Calendar range kuralı burada da geçerli (bkz. GecmisTaleplerFiltre.tsx) —
 * value olarak asla [null, null] verilmez.
 */
