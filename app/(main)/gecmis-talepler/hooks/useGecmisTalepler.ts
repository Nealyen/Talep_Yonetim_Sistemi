...
/**
 * HOOK: Geçmiş Talepler sayfasının state ve filtreleme mantığı.
 * NE İŞE YARAR: Kapatılmış (KAPATILDI) taleplerin çekilmesi; arama, kategori ve tarih
 * aralığı filtrelerinin uygulanması; Admin/Koordinatör için "Tüm Talepler / Kendi
 * Taleplerim" (scope) ayrımı.
 */
