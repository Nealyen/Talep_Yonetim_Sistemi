/**
 * BİLEŞEN: Geçmiş Talepler (Arşiv) tablosu — kapatılmış taleplerin salt-okunur listesi.
 */
...
export const GecmisTaleplerTablo = ({ tickets, onRowSelect }: GecmisTaleplerTabloProps) => {
    return (
        ...
        >
            ...
            <Column field="team" header="İlgili Ekip" style={{ width: '160px' }} body={(rowData: Ticket) => rowData.team || <span className="text-500">Atanmadı</span>} />
