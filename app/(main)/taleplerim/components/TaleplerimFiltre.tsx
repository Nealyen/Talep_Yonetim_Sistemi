/**
 * BİLEŞEN: Taleplerim filtre çubuğu (arama + kategori + tarih aralığı).
 * DİKKAT: Aynı Calendar range kuralı burada da geçerli — bkz.
 * GecmisTaleplerFiltre.tsx'teki açıklama (value asla [null, null] olamaz).
 */
...
export const TaleplerimFiltre = ({ search, onSearchChange, statusFilter, onStatusFilterChange, dateRange, onDateRangeChange }: TaleplerimFiltreProps) => {
    return (
        <div className="flex flex-wrap align-items-center gap-2 mb-3">
            ...
            <Calendar
                // bkz. GecmisTaleplerFiltre.tsx içindeki aynı kural: value asla
                // [null, null] olarak geçilmez, seçim yokken kesinlikle `null`.
