...
/**
 * MODAL: Mesai Onayları — bir koordinatör/admin'in teknisyenlerin girdiği mesai
 * kayıtlarını (WorkLog) tek tek onaylayıp reddedebildiği pencere.
 * components/tickets/WorkLogApprovalButton.tsx tarafından açılır.
 */
