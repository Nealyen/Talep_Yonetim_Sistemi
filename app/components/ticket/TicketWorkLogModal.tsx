/**
 * MODAL: Mesai/İş Kaydı (Work Log) girişi — bir teknisyenin bir talep üzerinde harcadığı
 * süreyi kaydetmesi için kullanılır. calculateBusinessTime/parseTurkishDate
 * (utils/ticketHelpers.ts) ile mesai saatleri hesaba katılarak gerçek çalışma süresi
 * hesaplanır.
 */
