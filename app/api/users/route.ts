/**
 * API ROUTE: GET/PATCH /api/users
 * DİKKAT — KULLANILMIYOR: bkz. app/api/tickets/route.ts'teki aynı not — frontend'den
 * çağrılmıyor, eski/prototip bir mock backend kalıntısıdır. Gerçek kullanıcı verisi
 * UserContext.tsx üzerinden localStorage'da tutuluyor.
 */
