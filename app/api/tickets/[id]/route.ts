 ...
 * DİKKAT — KULLANILMIYOR: Bu route, projenin geri kalanından (frontend) HİÇBİR YERDEN
 * çağrılmıyor. Gerçek uygulama artık TicketContext.tsx üzerinden localStorage ile
 * çalışıyor. Burada da farklı/eski bir rol adlandırması var (TALEP_SAHIBI,
 * TEKNIK_UZMAN — gerçek UserRole'de CALISAN, TEKNISYEN). Muhtemelen backend'e geçiş
 * için erken bir prototip kalıntısı; silinebilir ya da gerçek backend entegrasyonunda
