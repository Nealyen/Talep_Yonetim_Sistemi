...
/**
 * BİLEŞEN: Sağ kenardan açılan Tema/Görünüm Ayarları paneli (Sidebar) — renk şeması,
 * menü modu, input stili gibi PrimeReact tema ayarlarını değiştirmeyi sağlar.
 * Ayarlar layoutcontext.tsx (LayoutContext) üzerinden global state'e ve çerezlere
 * (cookie) yazılır.
 */
