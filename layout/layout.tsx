...
/**
 * BİLEŞEN: (main) rota grubunun GERÇEK layout'u — Topbar + Sidebar + Footer + AppConfig
 * yerleşimini kurar VE en kritik olarak UserProvider / TeamProvider / CategoryProvider
 * (TicketProvider ise bunların altında farklı bir yerde) context'lerini burada
 * sarmalar. Yani UserContext/TeamContext/CategoryContext'e erişim sadece (main) rota
 * grubundaki sayfalarda mümkündür.
 */
...
import { CategoryProvider } from '@/layout/context/CategoryContext';
