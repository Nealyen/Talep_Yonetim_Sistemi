...
/**
 * CONTEXT: Ekip (grup) adlarının merkezi listesi.
 * NE TUTAR: Basit bir string[] listesi (ekip adları) — Ekip Yönetimi sayfasından
 * eklenip silinir. Bu isimler; Kullanıcı & Rol Yönetimi'nde personel-ekip
 * eşleştirmesinde, Kategori Yönetimi'nde "hangi ekibe yönlendirilsin" seçiminde ve
 * İş Havuzu'ndaki görünürlük filtresinde referans olarak kullanılır.
 * KALICILIK: localStorage.
 * SAĞLADIĞI FONKSİYONLAR: addTeam, deleteTeam — bkz. useTeams() hook'u.
 */
