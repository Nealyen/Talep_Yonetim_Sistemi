...
/**
 * CONTEXT: Kullanıcı yönetimi — projenin EN KRİTİK context'lerinden biri.
 * NE TUTAR: Tüm kullanıcı listesi (AppUser[]), aktif oturum açmış kullanıcı
 * (currentUser — bu bir prototip olduğu için gerçek login yok, rol seçimiyle
 * "kullanıcı değiştirme" simüle ediliyor), her kullanıcının rolü (UserRole) ve
 * ekipleri (teams — bkz. TeamContext, CALISAN rolü hariç).
 * KALICILIK: localStorage, 'app_users' anahtarı altında.
 * SAĞLADIĞI FONKSİYONLAR: addUser, updateUser, resetUsers — bkz. useUser() hook'u.
 */
