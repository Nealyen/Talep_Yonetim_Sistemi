...
/**
 * BİLEŞEN: Sol menüdeki (AppMenu) tek bir menü öğesinin render mantığı — aktif rota
 * vurgusu, alt menü açma/kapama animasyonu (CSSTransition), rozet (badge) gösterimi.
 */
