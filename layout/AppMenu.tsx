...
/**
 * BİLEŞEN: Sol Menü — rol bazlı menü öğelerinin üretildiği yer.
 * NE İŞE YARAR: getFilteredMenu() aktif kullanıcının rolüne göre hangi menü
 * öğelerinin görüneceğine karar verir (bkz. SAYFA_REHBERI.md → "Roller" bölümü ile
 * birebir eşleşir). "Aktif Görevlerim" öğesindeki rozet (badge), onay bekleyen
 * atama sayısını gösterir.
 */
...
const AppMenu = () => {
    ...
    const getFilteredMenu = (): AppMenuItem[] => {
        ...
        if (activeRole === 'ADMIN') {
            ...
            kurumsalItems.push({ label: 'Kategori Yönetimi', icon: 'pi pi-fw pi-tags', to: '/kategori-yonetimi' });
