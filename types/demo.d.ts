/**
 * DİKKAT — ÇOĞUNLUKLA KULLANILMIYOR: PrimeReact "Sakai" şablonundan kalma demo tip
 * tanımları (FullCalendar, e-ticaret Product/Inventory tipleri vb.). Kurumsal talep
 * portalının gerçek iş mantığı bu tipleri kullanmaz; sadece types/layout.d.ts'in
 * import ettiği birkaç tip (Demo namespace) yüzünden hâlâ projede duruyor.
 */
